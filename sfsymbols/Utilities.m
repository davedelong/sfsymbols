...
// key and initialization vector for decoding the encrypted SYMP table
...
// quick-and-dirty way to parse a CSV line
// only handles the simplest cases of quoted fields, which is apparently sufficient for this task
